                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#exampleModalapUsuario<?php echo $i;?>">
                    <i class="bi bi-trash2-fill"></i>
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="exampleModalapUsuario<?php echo $i;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
