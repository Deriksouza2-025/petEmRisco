<p class="display-6 text-center alert text-light mt-2" style="background-color:rgb(46, 41, 103);">Atualizar Agenda</p>
...
<?php require './tab_most_result_update_agenda.php'; ?>