        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-3 min-vh-100 align-content-center mx-auto">
                    <form action="./cadastro.php" method="post" class="p-3">
                        <p class="lead display-6 text-center mb-4 text-light">Faça o seu cadastro</p>
                        <div>
                            <label for="nome" class="form-label lead text-light">Nome</label>
                        ...
                        <?php
                        require_once('../function/verificarCadastro.php');
                        verificarCadastro();
                        ?>
                        <div class="mt-4">
                            <p class="text-light">Já tem uma conta? <a href="../controls/index.php" class="text-light">Faça seu login</a></p>
                        </div>
                    </form>
                </div>
            </div>
